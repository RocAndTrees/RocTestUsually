...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/e6a795c97008e76cd259141301b7875b', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/e6a795c97008e76cd259141301b7875b',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "attr": {
	        "src": function () {return this.bgImage}
	      }
	    },
	    {
	      "type": "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  data: function () {return {
	    bgImage: 'http://img.ybzg.com/appbg/20170123.jpg',
	    image1: 'http://pic.pptbz.com/pptpic/201505/2015052211012624.jpg'
	  }},
	  methods: {
	    onClick1: function onClick1() {
	      var $modal = __weex_require__('@weex-module/modal');
	      $modal.toast({ 'message': '泊车', duration: 0.5 });
	    },
	    onClick2: function onClick2() {
	      var self = this;
	      var $modal = __weex_require__('@weex-module/modal');
	      $modal.toast({ 'message': '洗车', duration: 0.5 });
	    },
	    chooseCity: function chooseCity() {
	      var self = this;
	      var $modal = __weex_require__('@weex-module/modal');
	      $modal.toast({ 'message': '选择城市', duration: 0.5 });
	    },
	    alertChoose: function alertChoose() {
	      var self = this;
	      var $modal = __weex_require__('@weex-module/modal');
	      $modal.toast({ 'message': '弹出选择框', duration: 0.5 });
	    }
	  }
	};}
